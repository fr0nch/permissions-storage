...
INSERT IGNORE INTO perms_groups (id, name, priority, inheritance_id)
VALUES (1, 'Default', 0, NULL);

INSERT IGNORE INTO perms_servers (id, name, address, default_group)
VALUES (0, 'All Servers', NULL, 1);

INSERT IGNORE INTO perms_server_groups (id, server_id, group_id)
VALUES (1, 0, 1);
